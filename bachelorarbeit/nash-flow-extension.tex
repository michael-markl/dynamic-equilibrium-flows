...
\todo{Der Abschnitt wird mit der Fortsetzung zu Bemerkung~\ref{remark-thin-flow} abgeschlossen.}
...
\end{theorem}
\begin{proof}
	Man betrachte auf der Menge $M$ aller dynamischer Nash-Flüsse mit Zeithorizont $T$, wobei $T=\infty$ zugelassen wird, und Netzwerkzufluss $d$ die folgende Ordnung $\preceq\subseteq M\times M$:
