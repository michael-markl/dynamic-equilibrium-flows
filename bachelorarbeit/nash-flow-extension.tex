...
Schnell kann man sehen, dass sich die Ergebnisse aus den vorherigen Abschnitten ohne großen Aufwand übertragen lassen:
...
\begin{proof}
	...
	Daher ist die normierte Auslastung eines $s$-$v$-Pfades in $\mathcal{N}$ gerade die Auslastung vom durch die Kante $(s', s)$ verlängerten Pfad in $\mathcal{N'}$.
\end{proof}

Dadurch kann ein normierter schmaler Fluss durch die Bestimmung eines nicht-normier\-ten schmalen Flusses ermittelt werden.
