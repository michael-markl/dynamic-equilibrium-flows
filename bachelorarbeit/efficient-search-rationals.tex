...
\begin{proof}	
	...
	\begin{description}
 	...
 	Dies folgert man per Induktion über die Anzahl $i$ der Ausführungen des dritten Falls, wobei der Fall $i=0$ klar ist.
 	...
 	Bis inklusive Runde $k'$ wurden also nach Induktionsvoraussetzung höchstens $9k'$ Vergleiche verwendet.
