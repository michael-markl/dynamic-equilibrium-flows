...
Die Ergebnisse werden nun im folgenden Korollar gesammelt.

\begin{corollary}
	Ein auslastungsminimaler $b$-Fluss kann mit $\bigO((\size{b}+\size{u}) \abs{V}^2 \abs{E})$ arithmetischen Operationen auf Zahlen mit Kodierungslänge $\bigO(\size{b} + \size{u})$ berechnet werden.
\end{corollary}