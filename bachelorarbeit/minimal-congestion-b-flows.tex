...
\begin{proof}
	...
	Sonst berechne man in~$\bigO(n+m)$ Operationen zum Beispiel mit Tarjan's Algorithmus (siehe \todo{add cite}) die starken Zusammenhangskomponenten und damit den Zusammenhangsgraph des Residualgraphen $G_f$.
	...
	Eine topologische Sortierung auf dem azyklischen Zusammenhangsgraphen kann ebenfalls mit $\bigO(n + m)$ Operationen berechnet werden (siehe \todo{cite}).
