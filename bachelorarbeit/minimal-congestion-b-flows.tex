...
\begin{proposition}\label{prop-augment-min-con-flow-with-circuit}
	...
	Weiter seien $C$ ein Kreis im Residualgraph $G_f$ und $E_C'$ die Flaschenhalskanten von $f$, die $C$ als Rückwärtskanten verwendet.
...
\begin{proposition}\label{prop-min-bottlenecks-between-strong-comps}
	...
	Dann ist die Menge $E'$ der Flaschenhalskanten von $f$, die als Rückwärtskanten zwischen starken Zusammenhangskomponenten von $G_f$ verlaufen, die minimale Menge an Flaschenhalskanten.
	Außerdem stimmt der Zusammenhangsgraph von $G_f$ mit dem des Residualgraphen eines auslastungsminimalen $b$-Flusses mit Flaschenhalskanten $E'$ überein.
\end{proposition}
\begin{proof}
...
\begin{proof}
	...
	Nach Proposition~\ref{prop-min-bottlenecks-between-strong-comps} sind die Flaschenhalskanten, die als Rückwärtskante zwischen den Zusammenhangskomponenten verlaufen, gerade die minimale Menge $E'$ der Flaschenhalskanten.
