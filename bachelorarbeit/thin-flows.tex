...
\begin{lemma}
	Für einen schmalen Fluss $x$ in einem Netzwerk $(V, E, s, \emptyset)$ mit Ursprung $s$ und ohne Zurücksetzen ist die maximale Auslastungsübertragung $\max_{vw\in E} \rho_{vw}(l_v, x_{vw})$
\end{lemma}
