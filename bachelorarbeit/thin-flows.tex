...
\begin{proposition}\label{prop-restricted-minimal-flow-is-b-flow-on-induced-instance}
	Sei $f$ ein auslastungsminimaler $b$-Fluss einer $b$-Fluss-Instanz $\mathcal{I}$ in einem $s$-Netzwerks mit $b_s > 0$, so stimmen die Knotenauslastungen $l$ von $f$ auf $X$ mit der Knotenauslastung $l'$ von $f'$ überein.
\end{proposition}
\begin{proof}
	...
	Da jeder $s$-$v$-Pfad in $(X, E[X])$ auch in $(V, E)$ enthalten ist, ist die Auslastung $l'_v$ bereits maximal $l_v$.
	Außerdem liegt jeder $s$-$v$-Pfad in $(V, E)$ mit positivem Fluss bezüglich $f$ auch komplett in $(X, E[X])$, da $f$ auf $\delta^-_E(X)$ verschwindet.
	Daraus folgt $l'_v \geq l_v$.
	\todo{Das folgt noch nicht; brauche Inklusionsminimalität}
\end{proof}
