...
\begin{proof}
	...
	\[ l_w = f_{vw}/u_{vw} = f'_{vw_s}/u'_{vw_s} = \max\{ l_s, f'_{vw_s}/u'_{vw_s} \} \]
	nach~\ref{def-thin-flow-resetting-edge} für $vw$.
	Seien umgekehrt $f'$ ein schmaler Fluss in $\mathcal{N}'$ und $vw$ eine zurücksetzende Kante in $\mathcal{N}$.
	...
	\[
		l_w = \max \{ l_s, f'_{vw_s}/u'_{vw_s} \} = f_{vw} / u_{vw}.
	\]
\end{proof}
