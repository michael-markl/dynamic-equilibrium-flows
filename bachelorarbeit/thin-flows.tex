...
\end{definition}
\begin{definition}[Auslastung und Residualgraph eines $b$-Flusses]
...
\begin{proof}[Beweis von Lemma~\ref{lemma-min-flow-criterion}]
	Sei $f$ ein $b$-Fluss, dessen Residualgraph keine gerichteten Kreise mit einer maximal ausgelasteten Kante besitzt, und sei $e$ eine Kante mit Auslastung $c(f)$.
	...
	Da $g$ außerdem nur auf $E_f$ verläuft, enthält $E_f$ also den Zyklus $C_i$, der die maximal ausgelastete Kante $e$ benutzt, was im Widerspruch zur Voraussetzung steht.
\end{proof}
